    ...
    <div class="container">
        <div class="d-flex justify-content-between py-4">
            ...
            <button 
                ...
                data-bs-target="{{$limit_over ? '#limitWarning' : '#projectCreate'}}"
            >
                ...
                <table class="table table-borderless styled-table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center">{{__('Total QRCodes')}}</th>
                            <th scope="col" class="text-center">{{__('View QRCodes')}}</th>
                        ...
                        @foreach($projects as $project)
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    {{count($project->qrcodes)}}
                                </td>
                                <td class="text-center align-middle visited"> 
                                    <a href="/dashboard/project-qrcodes/{{$project->id}}">
                                        <span>{{__('View QR')}}</span>
                                    </a>
                                </td>
                                <td class="text-center align-middle">
